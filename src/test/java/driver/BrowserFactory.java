...
public class BrowserFactory {
    ...
    //pole określające czy uruchomienie będzie lokalne czy w Selenium Grid
    ...
    public WebDriver getBrowser() {
        ...
        //sprawdzenie czy uruchomienie lokalne czy zdalne, ponizej sciezka zdalna
        if(isRemoteRun) {

            //utworzenie obiektu Desired Capabilities
            DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
            //wybor przegladarki w zaleznosci od browserType
            switch (browserType) {
                case CHROME:
